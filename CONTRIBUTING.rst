...
Welcome to ``AutoHybrid`` contributor's guide.
...
If you experience bugs or general issues with ``AutoHybrid``, please have a look
...
You can help improve ``AutoHybrid`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``AutoHybrid`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``AutoHybrid``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n AutoHybrid python=3 six virtualenv pytest pytest-cov
    conda activate AutoHybrid
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/AutoHybrid.git
    cd AutoHybrid
...
#. Install |pre-commit|_::
   ...
   ``AutoHybrid`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/AutoHybrid
.. _issue tracker: https://github.com/<USERNAME>/AutoHybrid/issues
.. <-- end -->
